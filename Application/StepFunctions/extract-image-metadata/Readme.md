...
WORKDIR /src
COPY ["extract-image-metadata.csproj", "extract-image-metadata/"]
...
Execute unit tests
```
cd "extract-image-metadata/test/extract-image-metadata.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "extract-image-metadata/src/extract-image-metadata"
